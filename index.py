        ...
        if chat_member.status in ['member', 'administrator', 'creator']:
            ...
            if not received_initial_tokens:
                if remaining_tokens >= 3000:
                    ...
                    web_app_url = f"https://nur521.github.io/ma/?username={call.from_user.username}&user_id={user_id}&balance={user_tokens + 3000}&remaining_tokens={remaining_tokens}&referrals={referral_count}"
                ...
                web_app_url = f"https://nur521.github.io/ma/?username={call.from_user.username}&user_id={user_id}&balance={user_tokens}&remaining_tokens={remaining_tokens}&referrals={referral_count}"
